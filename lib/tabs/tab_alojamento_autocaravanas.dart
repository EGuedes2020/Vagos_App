...
class Autocaravanas extends StatefulWidget {
  const Autocaravanas({Key key}) : super(key: key);

  @override
  _AutocaravanasState createState() => _AutocaravanasState();
}

class _AutocaravanasState extends State<Autocaravanas> {
  //ICON GUARDAR
                              ...
                              children: [
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: SizedBox(
                                            ...
                                            child: Text('Parque de estacionamento, Praia da Vagueira', style: Theme.of(context).textTheme.headline6.merge(TextStyle(fontWeight: FontWeight.w400, fontSize: 16)),)),
                                      ),
                                    ],
                                  ),
                                ),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 16),
                                      child: Text('desde 7', style: Theme.of(context).textTheme.headline6.merge(TextStyle(fontWeight: FontWeight.w400, fontSize: 16)),),
                                    ),
                                  ],
                                ),
                              ],
