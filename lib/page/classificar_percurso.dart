...
class ClassificarPercurso extends StatefulWidget {
  const ClassificarPercurso({Key key}) : super(key: key);

  @override
  _ClassificarPercursoState createState() => _ClassificarPercursoState();
}

class _ClassificarPercursoState extends State<ClassificarPercurso> {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text('Classifique o Percurso', style: Theme.of(context).textTheme.headline5,),
              Padding(
