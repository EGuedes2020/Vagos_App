...
class Campismo extends StatefulWidget {
  const Campismo({Key key}) : super(key: key);

  @override
  _CampismoState createState() => _CampismoState();
}

class _CampismoState extends State<Campismo> {
  //ICON GUARDAR
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: SizedBox(
                                            ...
                                            child: Text('Rua Parque do Campismo, Gafanha da Boa-Hora, 3840-254', style: Theme.of(context).textTheme.headline6.merge(TextStyle(fontWeight: FontWeight.w400, fontSize: 16)),)),
                                      ),
                                    ],
                                  ),
                                ),
